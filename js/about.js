export function renderAboutView(container) {
  container.innerHTML = `
    <div class="about-view-card">
      ...
      <p>The optimal breathing pattern for health is about 4.5 seconds in, 4.5 seconds out, all through the nose. This app helps you practice that, without distractions, ads, or "woo woo".</p>
